...
//ВОПРОС 3:
        // В Java можно использовать оператор instanceof
        ...
        // поэтому невозможно использовать instanceof с несвязанным классом.
        ...
        // Мы не можем использовать instanceof, чтобы проверить,
